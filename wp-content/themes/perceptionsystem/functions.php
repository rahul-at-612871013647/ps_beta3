...
function twentytwenty_register_styles() {
	...
	wp_enqueue_style( 'twentytwenty-enhanced', get_template_directory_uri() . '/css/enhanced.css', '','','screen  and (min-width: 40.5em)' );
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'twentytwenty-modernizr', get_template_directory_uri() . '/js/modernizr.js', array(), $theme_version, false );
    wp_enqueue_script( 'twentytwenty-jq', get_template_directory_uri() . '/js/jquery.js', array(), $theme_version, false );
    wp_enqueue_script( 'twentytwenty-bootstrap', get_template_directory_uri() . '/js/init.js', array(), $theme_version, false );
